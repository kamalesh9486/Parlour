...
?>
                     ...
                     <?php } else { ?>
                      <td ><?php  echo $row['Status'];?></td><?php } ?> 
                                       <td width="150"><a href="view-appointment.php?viewid=<?php echo $row['bid']; ?>&serviceid=<?php echo $row['service_id']; ?>" class="btn btn-primary btn-sm">View</a>
