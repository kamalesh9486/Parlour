...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
          ...
          <button><a href="all-appointment.php"></a></button>
...
$serviceQuery = mysqli_query($con, "SELECT service_name FROM services WHERE service_id='$ser'");
...
?>                <h4>Service Name: <?php echo $serviceName; ?></h4>
