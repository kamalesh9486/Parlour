    ...
    <section class="slide slide-two">
      <div class="container">
        <div class="banner-text">
          ...
          <h3>beauty salon<br>
            fashion for woman</h3>
          <a href="services1.php" class="btn logo-button top-margin">Get An Appointment</a>
          <a href="services1.php" class="btn logo-button top-margin">Ge An Appointment</a>
		...
		<div class="container">
				...
				<div class="column2 image-text">
					...
					<p class="para  text ">
						...
						<a href="services1.php" class="btn logo-button top-margin mt-4">Get An Appointment</a>
				</div>
			</div>
		</div>
	</div>
