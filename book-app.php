...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"insert into tblbook(UserID,AptNumber,AptDate,AptTime,Message,service_id,specialist_id) value('$uid','$aptnumber','$adate','$atime','$msg','$ser','$sp')");
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Service Name</h6>
                            <h1><b> <?php echo $service['service_name']; ?></b></h1>                  
                             </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            ...
                            <p class="para"><a href="tel:+44 99 555 42"><?php echo $specialist['name']; ?></a></p>
                        </div>
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><?php echo $specialist['contact_info']; ?></p>
                        </div>
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Mobile No</h6>
                            <p class="para"><?php echo $specialist['mobile_number']; ?></p>
                        </div>
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Specialtiy</h6>
                            <p class="para"><?php echo $specialist['specialty']; ?></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Time</h6>
                            <p class="para"> <?php echo $specialist['availability']; ?></p>
                        </div>
                    </div>
               <?php } ?> </div>
